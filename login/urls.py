...
from . import views
from login.api import UserModelViewSet,MessageModelViewSet

router = DefaultRouter()
router.register('user', UserModelViewSet, basename='user-api')
router.register('chatbox', MessageModelViewSet, basename='message-api')


urlpatterns = [
    path('messages/api/v1/', include(router.urls)),
